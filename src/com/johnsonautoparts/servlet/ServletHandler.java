  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    switch (action) {
      ...
      default:
         ...
         *
         * <p>RISK: The webapp should make a clear distinction between how requests are process such
         * as by POST or GET. Unclear application flow may occur if GET and POST requests are

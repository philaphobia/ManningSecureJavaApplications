 ...
 *
 * <p>Session Listener for for the start and ending of a user session. This class registers into
 * Tomcat via the web.xml and provides logs to help in debugging the webapp.
 */
  ...
  public void sessionCreated(HttpSessionEvent sessionEvent) {
    ...
    if (session != null) {
      ...
      try {
        ...
        AppLogger.log(
            "Session created with error.  ID: " + session.getId() + "  Error: " + ise.toString());
      } catch (DBException dbe) {
        AppLogger.log(
            "Session create exception ID: " + session.getId() + "  Error: " + dbe.toString());
      }
    }
  }
  ...
  public void sessionDestroyed(HttpSessionEvent sessionEvent) {
    ...
    if (session != null) {
      try {
        ...
        AppLogger.log(
            "Session destroy with error.  ID: " + session.getId() + "  Error: " + ise.toString());
      } catch (SQLException e) {
        AppLogger.log(
            "Session destroy exception ID: " + session.getId() + "  Error: " + e.toString());
      }
    }
  }
}
